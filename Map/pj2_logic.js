...
// Loop through the stations array and create one marker for each city object
for (var i = 0; i < linea2.length; i++) {
    L.circle(linea2[i].location, {
      fillOpacity: 0.75,
      color: "blue",
      fillColor: "blue",
      // Setting our circle's radius equal to the output of our markerSize function
...
var linea3 = [
  ...
  // Loop through the stations array and create one marker for each city object
for (var i = 0; i < linea3.length; i++) {
    L.circle(linea3[i].location, {
      fillOpacity: 0.75,
      color: "green",
      fillColor: "green",
      // Setting our circle's radius equal to the output of our markerSize function
...
// Loop through the stations array and create one marker for each city object
for (var i = 0; i < linea4.length; i++) {
    L.circle(linea4[i].location, {
      fillOpacity: 0.75,
      color: "#B0F9BB",
      fillColor: "#B0F9BB",
      // Setting our circle's radius equal to the output of our markerSize function
...
// Loop through the stations array and create one marker for each city object
  for (var i = 0; i < linea5.length; i++) {
    L.circle(linea5[i].location, {
      fillOpacity: 0.75,
      color: "yellow",
      fillColor: "yellow",
      // Setting our circle's radius equal to the output of our markerSize function
